...
Currently, we are allowing all origins while testing, but in production, we should restrict it to the frontend domain. 
...
- User Type: Choose between "External" and "Internal".
